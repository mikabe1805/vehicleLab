...
public class Group1_2_TeslaModelZ_Driving extends BCATestScenario {
    ...
    public int runTest() {
        ...
        assertEquals(tesla.getRemainingRange(), 100.0, .1, "Tesla should have 100 miles left.");
        ...
        assertEquals(tesla.getRemainingRange(), 0.0, .1, "Tesla should have 0 miles left.");
        assertEquals(tesla.getMaxRange(), 340.0, .1, "Tesla should have 340 miles as its max range.");

        tesla.recharge();
        assertEquals(tesla.getRemainingRange(), 340.0, .1, "Tesla should have 340 miles left.");
        ...
        assertEquals(tesla.getMileage(), 980.0, .1, "Tesla should have 980 miles driven.");

        tesla.driveAutonomously(150.0);
        assertEquals(tesla.getMileage(), 1080.0, .1, "Tesla should have 1080 miles driven.");
        assertEquals(tesla.getRemainingRange(), 0.0, .1, "Tesla should have 0 miles left.");
